...
- [x] Генератор приложения, модулей, контроллеров, моделей, плагинов, компонентов (рутину делаем за вас)
- [x] Модульная MVC архитектура
- [x] Шаблонизатор Mozilla Nunjucks
- [x] Плагины и компоненты
- [x] Возможность встраивать плагины и компоненты как на программном уровне, так и тегов в шаблоне или контенте
